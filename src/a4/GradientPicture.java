...
public class GradientPicture implements Picture {
    ...
    public Picture paint(int x, int y, Pixel p, double factor) {
        ...
        this.gradientArr[x][y] = p.blend(p, factor);
        return this;
    }
    ...
    public Picture paint(int ax, int ay, int bx, int by, Pixel p, double factor) {
        ...
        for (int i = ax; i <= bx; i++) {
            for (int j = ay; j <= by; j++) {
                this.gradientArr[i][j] = p.blend(p, factor);
            }
        }
        return this;
    }
    ...
    public Picture paint(int cx, int cy, double radius, Pixel p) {
        ...
        for (int i = 0; i < this.gradientArr.length; i++) {
            for (int j = 0; j < this.gradientArr[0].length; j++) {
